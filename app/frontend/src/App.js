...
function App() {
  ...
  // Capturar Dados
  function getData() {
    fetch(`https://todo-mern-backend-production.up.railway.app/to-do/list` || `${url}/list`, { method: "GET" })
  ...
  function insertDocument(item) {
    fetch(`https://todo-mern-backend-production.up.railway.app/to-do/add` || `${url}/add`, {
      method: "POST",
  ...
  function updateDocument(item) {
    fetch(`https://todo-mern-backend-production.up.railway.app/to-do/update` || `${url}/update`,  {
      method: "PATCH",
      headers: { 'Content-Type': 'application/json' },
  ...
  function deleteDocument(item) {
    fetch(`https://todo-mern-backend-production.up.railway.app/to-do/delete` || `${url}/delete`, {
      method: "DELETE",
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(item),
    })
